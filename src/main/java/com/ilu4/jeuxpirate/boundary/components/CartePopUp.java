...
public class CartePopUp extends JWindow {

    public CartePopUp(JFrame parent, Image image) {
        super(parent);
        ...
        Toolkit.getDefaultToolkit().addAWTEventListener(new AWTEventListener() {
            ...
            public void eventDispatched(AWTEvent event) {
                if (event instanceof MouseEvent e && e.getID() == MouseEvent.MOUSE_PRESSED) {
                    ...
                    if (clicked == null || !SwingUtilities.isDescendingFrom(clicked, CartePopUp.this)) {
